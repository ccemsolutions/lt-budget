...
const DEFAULT_INPUTS: ProjectInputsWrite = {
  ...
  engineering: {
    ...
    ancoragens: 0,
    peso_torres_estaiadas_ton: 0,
    peso_torres_ap_ton: 0,
    montagem_manual_estaiada_pct: 10,
    montagem_manual_ap_pct: 10,
    ...
    reaterro_normal_m3: 0,
    reaterro_solo_cimento_m3: 0,
    reaterro_solo_emprestimo_m3: 0,
    concrete_usinado_m3: 0,
    concrete_canteiro_m3: 0,
    concrete_manual_m3: 0,
    concrete_premoldado_m3: 0,
    concrete_premoldado_pecas: 0,
    rebar_ton: 0,
    chumbadores_ton: 0,
    grampo_u_un: 0,
    tubulao_tr: 0,
    chumbadores_m: 0,
    estai_ancorado_rocha_m: 0,
    viga_l_m: 0,
    estacas_aco_m: 0,
    estacas_concreto_m: 0,
    estacas_escavadas_m: 0,
    estacas_raiz_m: 0,
    helicoidais_m: 0,
    contrapeso_m: 0,
    perfuracao_m: 0,
    defensas_concreto_tr: 0,
    poco_profundo_m: 0,
  },
  terrain: {
    flat_pct: 0,
