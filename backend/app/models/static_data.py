...
class LaborRole(Base):
    ...
    dissidio: Mapped[float] = mapped_column(Numeric(14, 4), default=0)
    adic_transf: Mapped[float] = mapped_column(Numeric(14, 4), default=0)
    periculosidade_val: Mapped[float] = mapped_column(Numeric(14, 4), default=0)
    ...
    subtotal_sem_he: Mapped[float] = mapped_column(Numeric(14, 4), default=0)
    adic_produtividade: Mapped[float] = mapped_column(Numeric(14, 4), default=0)
    custo_admissao: Mapped[float] = mapped_column(Numeric(14, 4), default=0)
    desp_folga: Mapped[float] = mapped_column(Numeric(14, 4), default=0)
...
class EquipmentItem(Base):
    ...
    preco_combustivel: Mapped[float] = mapped_column(Numeric(10, 4), default=0)
    total_combustivel_mes: Mapped[float] = mapped_column(Numeric(14, 4), default=0)
    lavagem_mes: Mapped[float] = mapped_column(Numeric(14, 4), default=0)
    lubrificantes_mes: Mapped[float] = mapped_column(Numeric(14, 4), default=0)
    manutencao_pct: Mapped[float] = mapped_column(Numeric(8, 4), default=0)
